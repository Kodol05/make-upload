...
> **여기 적힌 것은 모두 채워졌다(2026-08-07).** 도감 16종의 한국어 문안과 네 언어 번역,
> 공식 출처 다섯 개, 품목 이미지 16장, 영상과 자막이 앱에 들어가 있다. 남은 것은
> **번역의 원어민 검토** 하나다.
>
> 문서는 남겨 둔다. 어떤 형식으로 무엇을 요청했는지가 그대로 있어서, 나중에 콘텐츠를
> 더할 때 같은 형식을 따르면 된다. 진행 상황은
> [콘텐츠 체크리스트](CONTENT_CHECKLIST.md)를 보라.
